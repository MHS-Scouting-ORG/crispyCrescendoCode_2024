...
public class A_PositionD extends SequentialCommandGroup {
    ...
    public A_PositionD(SwerveSubsystem swerveSub, UnderIntakeSubsystem intakeSub, IndexerSubsystem indexSub, ShooterSubsystem shooterSub, ElevatorSubsystem elevSub, PivotSubsystem pivotSub) {
        int red = 1;
